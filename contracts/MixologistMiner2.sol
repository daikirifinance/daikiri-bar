...
contract MixologistMiner2 is Ownable, ReentrancyGuard {
    ...
    function changeRequiredCollateralAmount(uint256 _newCollateralAmount) public onlyOwner returns (bool) {
