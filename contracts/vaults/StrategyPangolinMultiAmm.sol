...
contract StrategyPangolinMultiAmm is Ownable, ReentrancyGuard, Pausable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    address public constant vaultChefAddress =
        0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174;
    address public constant masterchefAddress = 0x574d3245e36Cf8C9dc86430EaDb0fDB2F385F829;
    address public wantAddress;
    address public token0Address;
    address public token1Address;
    address public earnedAddress;

    address public uniRouterAddress = 0xE54Ca86531e17Ef3616d22Ca28b0D458b6C89106;
    address public daikiRouterAddress = 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174; // not deployed yet
    ...
    address public constant daikiAddress =
        0xF315803Ba9dA293765ab163E7dB98E8d6Df6D361; // not deployed yet
    address public constant rewardAddress =
        0xE768c11Ce3250f65B57c08e0AfEFda1Df81f8f5c; // not deployed yet
    address public constant feeAddress =
        0xE768c11Ce3250f65B57c08e0AfEFda1Df81f8f5c; // not deployed yet
    address public constant withdrawFeeAddress =
        0xD12Bc198269A14475BaF42Fa38967F0075E9DF1e; // not deployed yet
    ...
    constructor(             
        ...
        address[] memory _buyBackTokenToDaikiPath
    ) {
        ...
        earnedToBuyBackTokenPath = _earnedToBuyBackTokenPath;
        buyBackTokenToDaikiPath = _buyBackTokenToDaikiPath;
    ...
    function earn() external nonReentrant whenNotPaused onlyGov {
        ...
        if (earnedAmt > 0) {
            ...
            if (earnedAddress != token0Address) {
                ...
                _safeSwap(earnedAmt.div(2), earnedToToken0Path, address(this), uniRouterAddress);
            }

            if (earnedAddress != token1Address) {
                // Swap half earned to token1
                _safeSwap(earnedAmt.div(2), earnedToToken1Path, address(this), uniRouterAddress);
            }
    ...
    function distributeRewards(uint256 _earnedAmt) internal returns (uint256) {
        if (rewardRate > 0) {
            ...
            _safeSwap(fee, earnedToUsdcPath, address(this), uniRouterAddress);
    ...
    function buyBack(uint256 _earnedAmt) internal returns (uint256) {
        if (buyBackRate > 0) {
            ...
            // Buy bakc tokens in DaikiriSwap
            _safeSwap(
                buyBackTokenAmt,
    ...
    function convertDustToEarned() external nonReentrant whenNotPaused {
        ...
        if (token0Amt > 0 && token0Address != earnedAddress) {
            ...
            _safeSwap(token0Amt, token0ToEarnedPath, address(this), uniRouterAddress);
        }
        ...
        if (token1Amt > 0 && token1Address != earnedAddress) {
            // Swap all dust tokens to earned tokens
            _safeSwap(token1Amt, token1ToEarnedPath, address(this), uniRouterAddress);
        }
    }
